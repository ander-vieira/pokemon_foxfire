...
enum {
	...
	TRAINER_PIC_RS_ACE_TRAINER_M,
	TRAINER_PIC_RS_ACE_TRAINER_F,
...
enum {
	...
	FACILITY_CLASS_RS_ACE_TRAINER_M,
	FACILITY_CLASS_RS_ACE_TRAINER_F,
...
// Pokémon.
#define F_TRAINER_PARTY_DEFAULT			0
#define F_TRAINER_PARTY_CUSTOM_MOVES	1
#define F_TRAINER_PARTY_CUSTOM_FULL		2

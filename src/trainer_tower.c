...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_ACE_TRAINER_M,  FACILITY_CLASS_RS_ACE_TRAINER_M,    MALE},
    {OBJ_EVENT_GFX_ACE_TRAINER_F,  FACILITY_CLASS_RS_ACE_TRAINER_F,  FEMALE},
    ...
    {OBJ_EVENT_GFX_ACE_TRAINER_M,  FACILITY_CLASS_DRAGON_TAMER,        MALE},
    ...
    {OBJ_EVENT_GFX_ACE_TRAINER_M,  FACILITY_CLASS_ACE_TRAINER_M,       MALE},
    {OBJ_EVENT_GFX_ACE_TRAINER_F,  FACILITY_CLASS_ACE_TRAINER_F,     FEMALE},
...
static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_ACE_TRAINER_M,  OBJ_EVENT_GFX_ACE_TRAINER_F,  FACILITY_CLASS_COOL_COUPLE,       MALE, FEMALE},
...
static const struct TrainerEncounterMusicPairs sTrainerEncounterMusicLUT[105] = {
    ...
    {FACILITY_CLASS_RS_ACE_TRAINER_F,       TRAINER_ENCOUNTER_MUSIC_COOL},
    ...
    {FACILITY_CLASS_RS_ACE_TRAINER_M,       TRAINER_ENCOUNTER_MUSIC_MALE},

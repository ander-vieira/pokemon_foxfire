...
static const s8 sSeag[][4] = {
                                   // Map                     X     Y
    [SEAGALLOP_VERMILION_CITY]  = {MAP(VERMILION_CITY),      0x18, 0x20},
...
static const u16 sTravelDirectionMatrix[] = {
    [SEAGALLOP_VERMILION_CITY]  = 0x3fe, // 1111111110
    [SEAGALLOP_ONE_ISLAND]      = 0x3fc, // 1111111100
    [SEAGALLOP_TWO_ISLAND]      = 0x3f8, // 1111111000
    [SEAGALLOP_THREE_ISLAND]    = 0x3f0, // 1111110000
    [SEAGALLOP_FOUR_ISLAND]     = 0x3e0, // 1111100000
    [SEAGALLOP_FIVE_ISLAND]     = 0x2c0, // 1011000000
    [SEAGALLOP_SIX_ISLAND]      = 0x200, // 1000000000
    [SEAGALLOP_SEVEN_ISLAND]    = 0x240, // 1001000000
    [SEAGALLOP_NAVEL_ROCK]      = 0x3e0, // 1111100000
    [SEAGALLOP_BIRTH_ISLAND]    = 0x000  // 0000000000
};

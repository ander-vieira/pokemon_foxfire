...
const u8 gText_GivePremierBall[] = _("And have a PREMIER BALL,\nfree of charge!");
...
const u8 gText_Lemonade_400[] = _("LEMONADE{CLEAR_TO 0x57}{FONT_SMALL}¥400");
...
const u8 gText_Move_IcePunch[] = _("ICE PUNCH");
const u8 gText_Move_ThunderPunch[] = _("THUNDER PUNCH");
const u8 gText_Move_FirePunch[] = _("FIRE PUNCH");
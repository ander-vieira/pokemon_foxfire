...
static const struct RematchData sRematches[] = {
   ...
   { {TRAINER_PKMN_RANGER_KATELYN, SKIP, SKIP, SKIP, SKIP, TRAINER_PKMN_RANGER_KATELYN_2},
      MAP(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_ACE_TRAINER_LEROY, SKIP, SKIP, SKIP, SKIP, TRAINER_ACE_TRAINER_LEROY_2},
      MAP(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_ACE_TRAINER_MICHELLE, SKIP, SKIP, SKIP, SKIP, TRAINER_ACE_TRAINER_MICHELLE_2},
      MAP(SEVEN_ISLAND_SEVAULT_CANYON) },

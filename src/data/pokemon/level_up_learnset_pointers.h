const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_METAPOD] = sMetapodKakunaLevelUpLearnset,
    [SPECIES_BUTTERFREE] = sButterfreeLevelUpLearnset,
    [SPECIES_WEEDLE] = sWeedleLevelUpLearnset,
    [SPECIES_KAKUNA] = sMetapodKakunaLevelUpLearnset,
    ...
    [SPECIES_PIKACHU] = sPikachuRaichuLevelUpLearnset,
    [SPECIES_RAICHU] = sPikachuRaichuLevelUpLearnset,
    ...
    [SPECIES_CLEFAIRY] = sClefairyClefableLevelUpLearnset,
    [SPECIES_CLEFABLE] = sClefairyClefableLevelUpLearnset,
    [SPECIES_VULPIX] = sVulpixNinetalesLevelUpLearnset,
    [SPECIES_NINETALES] = sVulpixNinetalesLevelUpLearnset,
    [SPECIES_JIGGLYPUFF] = sJigglypuffWigglytuffLevelUpLearnset,
    [SPECIES_WIGGLYTUFF] = sJigglypuffWigglytuffLevelUpLearnset,
    [SPECIES_ZUBAT] = sZubatLevelUpLearnset,
    [SPECIES_GOLBAT] = sGolbatCrobatLevelUpLearnset,
    [SPECIES_ODDISH] = sOddishLevelUpLearnset,
    [SPECIES_GLOOM] = sGloomBellossomLevelUpLearnset,
    ...
    [SPECIES_EXEGGCUTE] = sExeggcuteExeggutorLevelUpLearnset,
    [SPECIES_EXEGGUTOR] = sExeggcuteExeggutorLevelUpLearnset,
    ...
    [SPECIES_CHANSEY] = sChanseyBlisseyLevelUpLearnset,
    ...
    [SPECIES_STARYU] = sStaryuStarmieLevelUpLearnset,
    [SPECIES_STARMIE] = sStaryuStarmieLevelUpLearnset,
    ...
    [SPECIES_CROBAT] = sGolbatCrobatLevelUpLearnset,
    ...
    [SPECIES_BELLOSSOM] = sGloomBellossomLevelUpLearnset,
    ...
    [SPECIES_BLISSEY] = sChanseyBlisseyLevelUpLearnset,
    ...
    [SPECIES_OLD_UNOWN_B] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_C] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_D] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_E] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_F] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_G] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_H] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_I] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_J] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_K] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_L] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_M] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_N] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_O] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_P] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_Q] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_R] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_S] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_T] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_U] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_V] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_W] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_X] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_Y] = sDummyLevelUpLearnset,
    [SPECIES_OLD_UNOWN_Z] = sDummyLevelUpLearnset,

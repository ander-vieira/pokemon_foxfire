const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_RS_ACE_TRAINER_M]       = TRAINER_PIC_RS_ACE_TRAINER_M,
    [FACILITY_CLASS_RS_ACE_TRAINER_F]       = TRAINER_PIC_RS_ACE_TRAINER_F,
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_RS_ACE_TRAINER_M]       = TRAINER_CLASS_RS_ACE_TRAINER,
    [FACILITY_CLASS_RS_ACE_TRAINER_F]       = TRAINER_CLASS_RS_ACE_TRAINER,

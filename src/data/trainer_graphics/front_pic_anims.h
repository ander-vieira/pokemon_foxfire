...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_RS_ACE_TRAINER_M]      = sAnims_RSCooltrainerM,
    [TRAINER_PIC_RS_ACE_TRAINER_F]      = sAnims_RSCooltrainerF,
    ...
    [TRAINER_PIC_ACE_TRAINER_M]         = sAnims_CooltrainerM,
    [TRAINER_PIC_ACE_TRAINER_F]         = sAnims_CooltrainerF,

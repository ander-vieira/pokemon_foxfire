...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(RS_ACE_TRAINER_M, gTrainerFrontPic_RSCooltrainerM, 0x800),
    TRAINER_SPRITE(RS_ACE_TRAINER_F, gTrainerFrontPic_RSCooltrainerF, 0x800),
    ...
    TRAINER_SPRITE(ACE_TRAINER_M, gTrainerFrontPic_CooltrainerM, 0x800),
    TRAINER_SPRITE(ACE_TRAINER_F, gTrainerFrontPic_CooltrainerF, 0x800),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(RS_ACE_TRAINER_M, gTrainerPalette_RSCooltrainerM),
    TRAINER_PAL(RS_ACE_TRAINER_F, gTrainerPalette_RSCooltrainerF),
    ...
    TRAINER_PAL(ACE_TRAINER_M, gTrainerPalette_CooltrainerM),
    TRAINER_PAL(ACE_TRAINER_F, gTrainerPalette_CooltrainerF),
